...
class Taunts:
    ...
    def __init__(self):
        ...
        # do not add unused taunts to this list
        self.__taunts = [
            self.__agathaMaaTaunts,
            self.__agathaArcherTaunts,
            self.__agathaVanTaunts,
    ...
    def getResponse(self, voice="no voice"):
        if voice == "agathamaa":
            return self.__agathaMaaTaunts
        elif voice == "agathaarcher":
            return self.__agathaArcherTaunts
        elif voice == "agathavan":
            return self.__agathaVanTaunts
        elif voice == "agathaknight":
            return self.__agathaKnightTaunts
        elif voice == "masonmaa":
            return self.__masonMaaTaunts
        elif voice == "masonarcher":
            return self.__masonArcherTaunts
        elif voice == "masonvan":
            return self.__masonVanTaunts
        elif voice == "masonknight":
            return self.__masonKnightTaunts
        elif voice == "unused":
            return self.__unusedTaunts
        else:
            return random.choice(self.__taunts)
...
class Respect:
    ...
    def getResponse(self, voice="no voice"):
        if voice == "agathamaa":
            return self.__agathaMaaRespect
        elif voice == "agathaarcher":
            return self.__agathaArcherRespect
        elif voice == "agathavan":
            return self.__agathaVanRespect
        elif voice == "agathaknight":
            return self.__agathaKnightRespect
        elif voice == "masonmaa":
            return self.__masonMaaRespect
        elif voice == "masonarcher":
            return self.__masonArcherRespect
        elif voice == "masonvan":
            return self.__masonVanRespect
        elif voice == "masonknight":
            return self.__masonKnightRespect
        else:
            return random.choice(self.__respect)
...
class Thank:
    ...
    def __init__(self):
        ...
        self.__agathaMaaThank = ["thanks for your aid!",
                                 "thanks, my brother!",
                                 "I owe you!"]

        self.__agathaArcherThank = ["you've done me a great kindness!",
                                    "you are a true friend!",
                                    "i am in your debt!"]

        self.__agathaVanThank = ["I'm in your debt!",
                                 "good looking out!",
                                 "whoa, thanks!"]

        self.__agathaKnightThank = ["thank you, :b:rother!",
                                    "thank you, brother!",
                                    "thank you, brother!",
                                    "thank you, brother!",
                                    "thank you, brother!",
        ...
        self.__masonMaaThank = ["you have done me a great favor!",
                                "wow! Thank you!",
                                "I owe you one!",
                                "oh! Thanks!"
                                ]

        self.__masonArcherThank = ["you have my gratitude!",
                                   "my thanks!",
                                   "my gratitude!",
                                   "I appreciate your help!"
                                   ]

        self.__masonVanThank = ["thanks! Thank you!",
                                "thanks for you aid!",
                                "thanks for your help!"
                                ]

        self.__masonKnightThank = ["your mead is on me!",
                                   "now I'm in your debt!",
                                   "I owe you"
                                   ]

        self.__thankLines = [
            self.__agathaMaaThank,
            self.__agathaArcherThank,
            self.__agathaVanThank,
            self.__agathaKnightThank,
            self.__masonMaaThank,
            self.__masonArcherThank,
            self.__masonVanThank,
            self.__masonKnightThank
        ]

    def getResponse(self, voice="no voice"):
        if voice == "agathamaa":
            return self.__agathaMaaThank
        elif voice == "agathaarcher":
            return self.__agathaArcherThank
        elif voice == "agathavan":
            return self.__agathaVanThank
        elif voice == "agathaknight":
            return self.__agathaKnightThank
        elif voice == "masonmaa":
            return self.__masonMaaThank
        elif voice == "masonarcher":
            return self.__masonArcherThank
        elif voice == "masonvan":
            return self.__masonVanThank
        elif voice == "masonknight":
            return self.__masonKnightThank
        else:
            return random.choice(self.__thankLines)
...
class NoOneHere:
    ...
    def __init__(self):
        ...
        self.__noOneHere = ["There's nobody here!",
...
class BirbBotSnark:
    ...
    def __init__(self):
        ...
        self.__refuseSelfInsult = ["BirbBot is very handsome and wonderful and not at all like that idiot "
                                   "{0.author.mention}",
...
class Error:
    ...
    def getResponse(self):
        return "If this triggers, something you seriously confused me. Please tell Raysparks <2>"

    def getServerError(self):
        return "Something went wrong while pinging the server! Either the requested server is offline, or Raysparks is an idiot! <1>"